...
def _cart_id(request):  # this function retrieves or creates session keys used as cart_id
...
def add_to_cart(request, product_id):
    ...
    try:
        cart = Cart.objects.get(cart_id=_cart_id(request))  # get cart id through sessions
